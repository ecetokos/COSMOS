    ...
    <div class="menu2">
      <div class="txt">
        ...
        <div class="btn-list">
          ...
          <button class="btn-list-btn">Gruplar</button>
        </div>
        ...
        <div class="btn-list">
          ...
          <button class="btn-list-btn">Radar</button>
        </div>
        ...
        <div class="btn-list">
          ...
          <button class="btn-list-btn">Meteroloji planları</button>
        </div>
        ...
        <div class="btn-list">
          ...
          <button class="btn-list-btn">Kullanıcı planları</button>
        </div>
        ...
        <div class="btn-list">
          ...
          <button class="btn-list-btn">Sistem planları</button>
        </div>
        ...
        <div class="btn-list">
          ...
          <button class="btn-list-btn">Kütüphane</button>
        </div>
        ...
        <div class="btn-list">
          ...
          <button class="btn-list-btn">Notlar</button>
        </div>
      </div>
    </div>
  );
